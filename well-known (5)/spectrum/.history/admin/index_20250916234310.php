...
<div class="sidebar" id="sidebar">
    ...
    <a href="#" onclick="loadPage('update_nav.php')"><i class="fa-solid fa-bars-staggered"></i> <span>header</span></a>
   <a href="#" onclick="loadPage('footer.php')"><i class="fa-solid fa-square-poll-horizontal"></i> <span>footer</span></a>
    ...
    <div class="submenu" id="aboutMenu">
        <a href="#" onclick="loadPage('about/first.php')">Introduction Title</a>
    ...
    <a href="#" onclick="loadPage('company_structure/company_locations.php')"><i class="fa-solid fa-building"></i> <span>company_structure</span></a>

    <div class="menu-toggle" onclick="toggleSubmenu('corporateMenu')">
        <i class="fa-solid fa-briefcase"></i> <span>Corporate Division ▾</span>
    </div>
    ...
    <a href="#" onclick="loadPage('devision/devision.php')"><i class="fa-solid fa-sitemap"></i> <span>our devision</span></a>

    <div class="menu-toggle" onclick="toggleSubmenu('servicesMenu')">
        <i class="fa-solid fa-cogs"></i> <span>services▾</span>
    </div>
    ...
    <a href="#" onclick="loadPage('contact.php')"><i class="fa-solid fa-envelope"></i> <span>all messages</span></a>
    <a href="#" onclick="loadPage('locate/locate.php')"><i class="fa-solid fa-map-marker-alt"></i> <span>add your locations</span></a>
