...
<body>
  ...
  <div class="who-we-are-section" style="content-visibility:auto; contain-intrinsic-size:1100px;">
        ...
        <div class="wh0-left-container">
          <div class="who-left-one">
            ...
            <div class="who-left-image">
              <img src="./assets/home/<?= $left_cards[0]['image1'] ?>" alt="Left Card Image" loading="lazy"
                decoding="async">

              <div class="card-two">
                <div class="card-two-container">
                  <img loading="lazy" decoding="async" src="./images/setting (2).png" alt="">
                  <p><?= htmlspecialchars($left_cards[0]['overlay_text'] ?? '') ?></p>
                </div>
              </div>
        ...
        <div class="who-left-two">
          <div class="who-left-image">
            <img loading="lazy" decoding="async"
              src="./assets/home/<?= $left_cards[0]['image2'] ?? 'fallback-bottom.jpg' ?>" alt="Bottom Left Image">
          </div>
        </div>
  ...
  <div class="company-spectrum-locations">
    ...
    <div class="spectrum-slider-structure">
      <div class="spectrum-infinite-container">
        ...
        <div class="spectrum-track">
          ...
          <?php mysqli_data_seek($company, 0);
